...
$id = $_GET['id'];
$sql = "SELECT * FROM Kategori WHERE Id=? LIMIT 1";
...
<form class="d-flex flex-column gap-1" action="/admin/editcategory?id=<?php echo $category['Id']; ?>" method="post">
    <h3>Edit Object</h3>  
    <div class="form-floating">
        <input class="form-control" type="text" value="<?php echo $category['Kategori']; ?>" name="kategori" id="objekt">
        <label class="form-label" for="objekt">Namn</label>
    </div>
    <div class="form-floating">
        <input class="form-control" type="text" name="uniktid" id="givare" value="<?php echo $category['UniktID'];?>">
